...
const EventForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create an explicit payload to ensure all required fields are included
      const payload = {
        name: formData.name,
        email: formData.email,
        date: formData.date,
        time: formData.time, // Make sure time is a string and not empty
        description: formData.description
      };
      
      // Debug: Log the exact payload that will be sent
      console.log('Final payload to be sent:', JSON.stringify(payload));
